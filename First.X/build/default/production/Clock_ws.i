...
void updateClock (int hours,int minutes,int seconds,int clock_mode, _Bool evening);
...
signed int ADC_read(void){
    ...
    signed int result;
    _delay((unsigned long)((20)*(3276800/4000000.0)));
    ADCON0bits.GO =1;
...
void __attribute__((picinterrupt(("")))) alarmISR(void){
